...
fetch(WEATHER_API_URL)
    ...
    .then(weatherData => {
        ...
        const timeSunrise = new Date(weatherData.sys.sunrise*1000)
        const timeSunset = new Date(weatherData.sys.sunset*1000)
        const weather = 'Thunderstorm' // weatherData.weather[0].main
        ...
        if(weather === 'Clouds'){
            messageContainer.innerHTML = /*html*/`
                ...
                <p>Light a fire and get cosy. ${weatherData.name} is looking grey today.</p>
            `
        }
