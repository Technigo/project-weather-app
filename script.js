  ...
  .then((weatherArray) => {
    ...
    const backgroundToggle = () => {
      ...
      if (weatherDescription.includes("clouds")) {
        ...
        cityContainer.innerHTML += `<svg xmlns="http://www.w3.org/2000/svg" width="77.194" height="53.261" viewBox="0 0 77.194 53.261">
      ...
      <h1> Light a fire and get cosy. ${weatherArray.name} is looking grey today.</h1>`
      }
      else if (weatherDescription.includes("rain")) {
        bodyContainer.classList.toggle("rainy");
        cityContainer.innerHTML += `<svg xmlns="http://www.w3.org/2000/svg" width="73.451" height="73" viewBox="0 0 73.451 73">
      ...
      <h1> Don't forget your umbrella today. It's wet in ${weatherArray.name} today.</h1>`
      }
      else if (weatherDescription.includes("clear")) {
        bodyContainer.classList.toggle("sunny");
        cityContainer.innerHTML += `<svg xmlns="http://www.w3.org/2000/svg" width="73.05" height="51.716" viewBox="0 0 73.05 51.716">
      ...
      <h1> Get your sunnies on. ${weatherArray.name} is looking rather great today.</h1>`
      }
    }
    backgroundToggle();
...
fetch(apiForecast)
  ...
  .then((forecastArray) => {
    ...
    filteredForecast.forEach((forecastArray) => {
      ...
      forecastContainer.innerHTML += `<table class="forecast-table"><td>${forcastDayString}</td> <td>${forecastWeather}</td> <td> ${forecastTemp}°C </td> </table>`
...
//name of the city
    // cityContainer.innerHTML += `<h1> Light a fire and get cosy. ${weatherArray.name} is looking grey today.</h1>`
    // toggle background color
/* if (temperature < 8) {
  topContainer.classList.toggle("cold");
}
else if (temperature > 8) {
  topContainer.classList.toggle("warm");
} */