...
const getWeatherData = (data) => {
  ...
  const sunriseString = sunriseData.toLocaleTimeString("en-SE", {
    hour: "2-digit",
    minute: "2-digit",
  }) //toLocaleTimeString reduces data to only show hh:mm
  const sunsetString = sunsetData.toLocaleTimeString("en-SE", {
    hour: "2-digit",
    minute: "2-digit",
  }) //toLocaleTimeString reduces data to only show hh:mm
