...
const weatherCurrentCopenhagen = () => {
    fetch('https://api.openweathermap.org/data/2.5/weather?q=Copenhagen,Denmark&units=metric&APPID=d8e3d440b59f81f07a8c91c14c07c06e')
        ...
        .then((json) => {
            ...
            city2.innerHTML += `${city2Name} <br>${city2temp}ºC <br><img id="main-icon" src='https://openweathermap.org/img/wn/${json.weather[0].icon}@2x.png' alt="${json.weather[0].description} icon" />`;
        })
};
...
const weatherCurrentBuenosAires = () => {
    fetch('https://api.openweathermap.org/data/2.5/weather?q=Buenos%20Aires,Argentina&units=metric&APPID=d8e3d440b59f81f07a8c91c14c07c06e')
        ...
        .then((json) => {
            ...
            city1.innerHTML += `${city1Name} <br>${city1temp}ºC <br> <img id="main-icon" src="https://openweathermap.org/img/wn/${json.weather[0].icon}@2x.png" alt="${json.weather[0].description} icon" />`;
        })
