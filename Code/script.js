...
const forecastStockholm =
  "https://api.openweathermap.org/data/2.5/forecast?q=Stockholm,Sweden&units=metric&APPID=e74df95bd073adf9306ac7f46ad51144";
...
const displayDays = (dayArray) => {
  ...
  for (i = 1; i < dayArray.length; i++) {
    ...
    weekdaysDiv.innerHTML += `<div class="week_days"> 
                                    ...
                                    <div>${getNumber(
                                      dayArray[i].main.temp
                                    )}&deg;C </div>
                                   <img src="https://openweathermap.org/img/wn/${
                                     dayArray[i].weather[0].icon
                                   }.png">
                                  </div>`;
  }
};
