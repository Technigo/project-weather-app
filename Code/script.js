...
const filterWeather = () => {
  ...
  .then((json) => {
    if (json.list[0].weather[0].main == 'Clouds' || json.list[0].weather[0].main == 'Mist') {
      ...
      aboutWeather.innerHTML += `<img class="weather-img" src="./icons/cloud.svg" alt="cloud icon">`
      ...
      aboutWeather.innerHTML += `<img class="weather-img" src="./icons/umbrella.svg" alt="umbrella icon">`
      ...
      aboutWeather.innerHTML += `<img class="weather-img" src="./icons/sunglasses.svg" alt="sun-glasses icon">`
...
const weatherFirstCity = () => {
  ...
  <img class="city-icon" src="./icons/eiffel-tower.png" alt="eiffel-tower icon"><br>
...
const weatherSecondCity = () => {
  ...
  <img class="city-icon" src="./icons/sagrada-familia.png" alt="sagrada-familia icon"><br>
  <p>${(Math.round(data.main.temp))}º | ${data.name}</p>
  `
  })
}
