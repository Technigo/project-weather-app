...
// Functions to set current weather data
const setWeatherData = (json) => {
...
// Function to set weather data forecast
const setWeatherForecast = (json) => {
    ...
    filteredForecast.forEach((item) => {
        ...
        fiveDaysForecast.innerHTML += `
            ...
            <div class = "accordion-content">
                <p>${weatherDescription}, feels like ${feelsLike} °C </p>
            </div>
        `;

        // Set accordion with data
        setAccordion()
    });
