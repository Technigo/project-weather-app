//Weather from API
const apiWeatherToday = 'https://api.openweathermap.org/data/2.5/weather?q=Stockholm,Sweden&units=metric&APPID=e33f1cc192401277e601a6aed3a82800'
...
const todaysDate = new Date();
  const dateFormatted = todaysDate.toLocaleDateString("en-EN", {year: 'numeric', month: 'short', day: 'numeric'})
...
fetch(apiForecast)
  ...
  filteredForecast.forEach(day => {
    ...
    document.getElementById('weekday').innerHTML += `<p>${dayName.toLowerCase()}</p>`
