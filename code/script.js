...
fetch(apiUrlFiveDays)
  ...
  .then((data) => {
    ...
    filteredForecast.forEach(day => {
      ...
      <div class='weekdays-container'><div class='day-container'>${forecastDay.toLocaleString('en-us', {weekday: 'short'}).toLowerCase()}</div><div class='temp-container'>${day.main.temp.toFixed(0)} &#176</div></div>
    `
    })
  })
  .catch(error => console.error(error))