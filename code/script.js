...
// Global variables
let URL_WEATHER = "https://api.openweathermap.org/data/2.5/weather?q=Stockholm,Sweden&units=metric&APPID=1ecbebf1161e80b656c352a8c659aec8"
let URL_FORECAST = "https://api.openweathermap.org/data/2.5/forecast?q=Stockholm,Sweden&units=metric&APPID=8802f8b4b2d622931613aace44be57ae";
...
fetch(URL_FORECAST)
  ...
  .then((data) => {
    ...
    currentWeather.innerHTML += `${data.list[0].weather[0].description} | ${data.list[0].main.temp.toFixed(1)}<sup>°C</sup> `;
