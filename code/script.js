...
const fetchingWeather = () => {
  ...
  const weatherDescription = (localWeatherToday, city) => {
    if (localWeatherToday === "Clear") {
                  ...
                  <h1> Sunglass-up. ${city} is shining and so are you!</h1>
                    <div class= "todays-item">
                      ...
                      <div class= "items-wrapper">
                        <img class= "item" src="images/keps.png"/> <img class= "item" src="images/tshirt.png"/>
                      </div>
                    </div>
                  </div>`;
      ...
      cityWeather.innerHTML = `<div class= "rain">
                  ...
                  <h1> Fetch that umbrella. ${city} is crying today.</h1>
                    <div class= "todays-item">
                      <p>Recommended clothing item:</p>
                      <div class= "items-wrapper">
                        <img class= "item" src="images/umbrellaitem.png"/> <img class= "item" src="images/raincoat.png"/> <img class= "item" src="images/raingloves.png"/>
                      </div>
                    </div>
                  </div>`;
      ...
      cityWeather.innerHTML = `<div class= "clouds">
                  ...
                  <h1> Cuddle up! The ${city} sky is grey today.</h1>
                    <div class= "todays-item">
                      <p>Recommended clothing items:</p>
                      <div class= "items-wrapper">
                        <img class= "item" src="images/gloves.png"/> <img class= "item" src="images/scarf.png"/> <img class= "item" src="images/beanie.png"/>
                      </div>
                    </div>
                  </div>`;
    ...
    todaysWeather.innerHTML = `<p> ${weatherResults.weather[0].description} | ${
      Math.round(weatherResults.main.temp * 10) / 10
    }° </p>
      <p>
      ...
      <img id= "wind" src="images/windspeed.png"/> <p>wind-speed | ${
        weatherResults.wind.speed
      }</p>`;
  };
};
